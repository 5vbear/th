 ...
 * @since JDK1.6
 */
public class SysUpdateManagementServlet extends BaseServlet {
	...
	static {
		...
		PAGE_FORWARD.put(REQ_PARAM_VALUE_BACKTOSENDUPDATEORDER, "/jsp/sysUpdateManagement/sysSendUpdateOrder.jsp");
	...
	public String doIt(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException, SQLException {
		...
		if (REQ_PARAM_VALUE_SENDUPDATEORDER.equals(paramAction)) {
			...
			Boolean sendFlag = action.sendSysUpdatePackagesToMachine(req.getParameter("macIds"), 
