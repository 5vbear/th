 ...
 *
 */
public class UpdateHistorySearchServlet extends BaseServlet {
	...
	SQLException {
		...
		if (session == null || session.getAttribute("user_info") == null) {
			...
			String jumpURL = "/jsp/updateManagement/UpdateHistorySearch.jsp";
					...
					if(dealFlg!=null&&dealFlg!=""){
						...
						if("search".equals( dealFlg )||"jump".equals( dealFlg )){
							...
							if(searchCond!=null){
								...
								upHistoryMap = umd.getUpHistorysBySearchCondition( uhsb );
