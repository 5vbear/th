...
//                             document.getElementById('hiddenId').style.height = "30px";
                    ...
                    function addChannel(){
                    	document.getElementById('searchType').value = "addChannel";
                    	var form = document.getElementById('channelForm');
	...
	<form class="x-client-form" id="channelForm" action="">
		...
		<div id="foldId"
			...
			<div class="x-chanelName">
				<span>&nbsp;&nbsp;频道名称</span> <input type="text" name="channelName" id="channelNameId"/>
			</div>
			<div>
		...
		<table class="x-data-table" id="dataTableId">
			<tr>
				<td colspan="5" class="x-data-table-td" style="text-align: left">&nbsp;&nbsp;频道定义表</td>
			</tr>
			<tr>
				...
				<th style="width: 15%" class="x-data-table-th">频道名称</th>
				<th style="width: 30%" class="x-data-table-th">频道路径</th>
