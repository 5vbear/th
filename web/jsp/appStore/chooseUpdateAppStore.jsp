...
<script type="text/javascript">
	...
	%>	
	var formActionValue = ctx+"/jsp/appStore/ChooseAppStore.html";
	...
	function returnFunction(){
		subbmitForm(ctx+"/jsp/appStore/UpdateAppStoreManagement.html?action=backToSendUpdateAppOrder");
	}
...
<body>
	<form class="x-client-form" method="POST" name="form_data" action="" id="ChoosePackages">
		...
		<div>
			<div class="x-data"><span style="height:30px;width:100px;line-height:30px">&nbsp;&nbsp;应用管理-应用选择</span></div>
			...
			<div>
				...
				<table class="x-data-table" id="dataTableId" width="100%">
					<tr>
						...
						<th class="x-data-table-th" style="width:10%">应用名</th>
					...
					<%
						...
						for(int i=0;i<resultData.length;i++){
							...
							out.print("<td class='x-data-table-td'>&nbsp;"+tmp.get("APP_NAME")+"</td>");
