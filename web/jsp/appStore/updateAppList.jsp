...
<script type="text/javascript">
	...
	var formActionValue = ctx+"/jsp/appStore/UpdateAppStore.html";
	$(document).ready(function() {
		initTable();
...
<!-- 	<fieldset><legend>应用商店-应用上架</legend> -->
	<form class="x-client-form" method="POST" name="form_data" action="" id="PackagesList">
		...
		<div>
			<div class="x-data"><span style="height:30px;width:100px;line-height:30px">&nbsp;&nbsp;应用商店-应用上架</span></div>
		<div>
		<table><tr style ="heigt:30px"></tr></table>
			...
			<div>
				<table class="x-data-table" id="dataTableId"  style="width:100%;table-layout:fixed;">
					<tr>
						<th style="width:20px"><input type=checkbox
							name="checkAll" id="checkAll" /></th>
						<th class="x-data-table-th" style="width:100px" >应用名</th>
						<th class="x-data-table-th" style="width:80px">显示系统</th>
						<th class="x-data-table-th" style="width:120px">说明</th>
						<th class="x-data-table-th" style="width:40px">状态</th>
						<th class="x-data-table-th" style="width:60px">操作</th>
					</tr>
					<%
						...
						for(int i=0;i<resultData.length;i++){
							...
							out.print("<td class='x-data-table-td'>&nbsp;"+tmp.get("DEV_OS")+"</td>");
							out.print("<td class='x-data-table-td' title="+tmp.get("DESCRIPTION")+">&nbsp;"+tmp.get("DESCRIPTION")+"</td>");
							out.print("<td class='x-data-table-td' >&nbsp;"+tmp.get("STATUS")+"</td>");
							if(tmp.get("STATUS").equals("已上架")){
								out.print("<td class='x-data-table-td'>&nbsp;"
										+"<input class='tableBtn' type='button' value='上架' disabled name='buttonEdit_"+tmp.get("APP_ID")+"' id='btnEdit_"+tmp.get("APP_ID")+"' onclick='btnEditClick("+tmp.get("APP_ID")+")'/>"
							...
							out.print("<td class='x-data-table-td'>&nbsp;"
								+"<input class='tableBtn' type='button' value='上架' name='buttonEdit_"+tmp.get("APP_ID")+"' id='btnEdit_"+tmp.get("APP_ID")+"' onclick='btnEditClick("+tmp.get("APP_ID")+")'/>"
								//+"<input type='button' value='修改' name='buttonEdit_"+tmp.get("FILE_ID")+"' id='btnEdit_"+tmp.get("FILE_ID")+"' onclick='btnEditClick("+tmp.get("FILE_ID")+")'/>"
										+"<input class='tableBtn' type='button' value='删除' name='buttonDelete_"+tmp.get("APP_ID")+"' id='btnDel_"+tmp.get("APP_ID")+"' onclick='btnDeleteClick("+tmp.get("APP_ID")+")'/>"
										+"</td>");
							out.print("</tr>");
			...
			<div>
				...
				<div style="float: right">
					<input class="tableBtn" type="button" id="addButton" value="上架" />
