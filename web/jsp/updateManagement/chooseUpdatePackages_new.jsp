...
<script type="text/javascript">
	...
	function returnFunction(){
		subbmitForm(ctx+"/jsp/updateManagement/UpdateManagement.html?action=backToSendUpdateOrder_new&type=122");
	}
	...
	function chooseUpdatePackages(){
	    ...
	    subbmitForm(formActionValue+"?action=submitChoose_new");
	}
...
<body>
	<form class="x-client-form" method="POST" name="form_data" action="" id="ChoosePackages">
		...
		<div>
			<div class="x-data"><span style="height:30px;width:100px;line-height:30px">&nbsp;&nbsp;升级下发-升级包选择</span></div>
