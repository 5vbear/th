...
//**************
	...
	function chooseUpdatePackages(){
        ...
        $('#sendUpdateOrder')[0].action=ctx+"/jsp/updateManagement/ChoosePackages.html?action=chooseUpdatePackages&checkedIds="+checkedIds.substring(1)+"&checkedAll="+checkedAll+"&osType="+osType;
...
<div class="x-title"><span>&nbsp;&nbsp;升级管理-升级包下发</span></div>
		...
		<div>
			<div style="float: left">下发时间：
				<input type="text" readonly = "true" size="8" name="valueTime" id="valueTime" maxlength="10" style="ime-mode:disabled" 
					...
					&nbsp;&nbsp;
					<span id='ostypeAjaxSel'>设备类型 <select name="osType" id="osTypeId" onChange="initTreeByOS()" >
