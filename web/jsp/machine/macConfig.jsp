...
<html>
	<head>
		...
		<script language="JavaScript">
			...
			function treeSelected(event, treeId, treeNode){
				sub.location.href = '/th/machineServlet?model=config&method=goEdit&orgid='+treeNode.id
			}		
		</script>
		<style type="text/css">
	...
	<body style="background-color: #fff;">
		<div class="x-title"><span>&nbsp;&nbsp;端机管理-端机配置</span></div>
		<table><tr style ="height:3px"></tr></table>
		<div style="height: 520px; padding-top: 0px; float: left;">
    		<ul id="menu" class="ztree"></ul>
		</div>
		<div>
			<Iframe src="/th/machineServlet?model=config&method=goEdit&orgid=" scrolling="no" height="580" width="710" frameborder="0" name="sub" id="sub"></iframe>
		</div>	
	</body>
</html>