...
<script type="text/javascript">
	...
	%>	
	///jsp/sysUpdateManagement/SysChoosePackages.html
	var formActionValue = ctx+"/jsp/sysUpdateManagement/SysChoosePackages.html";
	...
	function returnFunction(){
		subbmitForm(ctx+"/jsp/sysUpdateManagement/SysUpdateManagement.html?action=backToSendUpdateOrder");
	}
...
<body>
	<form class="x-client-form" method="POST" name="form_data" action="" id="ChoosePackages">
		...
		<div>
			<div class="x-data"><span style="height:30px;width:100px;line-height:30px">&nbsp;&nbsp;系统升级管理-系统升级包选择</span></div>
			...
			<div>
				...
				<table class="x-data-table" id="dataTableId" width="100%">
					<tr>
						<th class="x-data-table-td" style="width:2%">
<!-- 						//wilson 20130116 check mac version add <input type=checkbox	name="checkAll" id="checkAll" /> -->
							&nbsp;
						</th>
					...
					<%
						...
						for(int i=0;i<resultData.length;i++){
							...
							out.print("<tr>");
							out.print("<td class='x-data-table-td'>&nbsp;<input type=radio name=list value='"+tmp.get("FILE_ID")+"' /></td>");
