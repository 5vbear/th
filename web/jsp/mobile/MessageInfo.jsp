...
<%@page import="th.entity.MessageBean"%>
...
<%
    ...
    //检索条件
    MessageBean selectBean = (MessageBean)request.getAttribute("select_object");
    //检索结果总数
    int total_num = 0;
    //当前页数
    int point_num = 1;
		...
		<p></p>
			<div style="OVERFLOW-Y:auto;height:425px;margin-left:20px;">
				<table id="dataTableId" width="800px" height="420px" border="0" cellspacing="1" cellpadding="3" align="center">
					<tr>
						<th style="width: 15%" class="th_tianhe">操作人员</th>
						<th style="width: 10%" class="th_tianhe">机器名</th>
						<th style="width: 15%" class="th_tianhe">组织名</th>
						<th style="width: 40" class="th_tianhe">内容</th>
