...
<script type="text/javascript">
	...
	var formActionValue = ctx+"/jsp/updateManagement/UpdatePackage.html";
	$(document).ready(function() {
		initTable();
...
<!-- 	<fieldset><legend>应用商店-应用上架</legend> -->
	<form class="x-client-form" method="POST" name="form_data" action="" id="PackagesList">
		...
		<div>
			<div class="x-data"><span style="height:30px;width:100px;line-height:30px">&nbsp;&nbsp;升级管理-升级文件管理</span></div>
		<div>
