...
strFrame+='             <td style="cursor:hand;visibility:hidden;" onclick="parent.tmpSelectSecondInnerHTML(this.innerText.length==3?this.innerText.substring(0,1):this.innerText.substring(0,2))"';
strFrame+=' onmouseover="style.backgroundColor=\'#aaccf3\'" onmouseout="style.backgroundColor=\'#63A3E9\'"';
strFrame+=' title="点击这里选择时间" align=center width=42>' ;
...
function WriteDateTo(yy,mm,n,hh,mi,se)
{
    if (bUseTime)
    {
        ...
        outObject.value= yy + "-" + format(mm) + "-" + format(n) + " " + format(hh) + ":" + format(mi); 
    }
    else
    {
