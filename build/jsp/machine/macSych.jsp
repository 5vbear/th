...
<html>
	<head>
		...
		<script language="JavaScript">
			...
			function treeSelected(event, treeId, treeNode){
				...
				sub.location.href = '/th/machineServlet?model=sych&method=view&macIdStd='+treeNode.id
			}		
		</script>
		<style type="text/css">
	...
	<body style="background-color: #fff;">
		<div class="x-title"><span>&nbsp;&nbsp;端机管理-端机同步</span></div>
		<table><tr style ="height:3px"></tr></table>
		<div style="height: 520px; padding-top: 0px; float: left;">
    		<ul id="menu" class="ztree"></ul>
		</div>
		<div>
			<Iframe src="/th/machineServlet?model=sych&method=view" scrolling="scroll" height="550" width="730" frameborder="0" name="sub" id="sub"></iframe>
		</div>
	</body>
</html>