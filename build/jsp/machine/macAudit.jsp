...
<html>
				...
				if (treeNode.isParent) {
			        ...
			        if (childrenNodes) {
			            for (var i = 0; i < childrenNodes.length; i++) {
			                if(childrenNodes[i].mactype == 'org'){
				                isChildOrg='1';
				            }
			            }
			        }
			    }
				sub.location.href = '/th/machineServlet?model=audit&method=maclistQry&orgid='+treeNode.id+'&isChildOrg='+isChildOrg;
			}		
		</script>
		<style type="text/css">
	...
	<body style="background-color: #fff;">
		<div class="x-title"><span>&nbsp;&nbsp;端机管理-端机审核</span></div>
		<table><tr style ="height:3px"></tr></table>
		<div style="height: 520px; padding-top: 0px; float: left;">
    		<ul id="menu" class="ztree"></ul>
		</div>
		<div>
			<Iframe src="/th/machineServlet?model=audit&method=maclistQry" scrolling="no" height="600" width="710" frameborder="0" name="sub" id="sub"></iframe>
		</div>	
	</body>
</html>