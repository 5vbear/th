...
<%@page import="th.action.report.ReportCommonAction"%>
<%@page import="th.entity.MultiRunningStatisticsBean"%>
...
<%
	...
	ArrayList<MultiRunningStatisticsBean> viewList = (ArrayList<MultiRunningStatisticsBean>)request.getAttribute("viewList");
	...
	String orgs = ReportCommonAction.getOrgNodes( request );
...
function check(){
	<%--document.form1.action = "/th/MultiRunningStatisticsServlet.html";
...
function exportReport(){
  	document.form1.action = "/th/MultiRunningStatisticsServlet.html?export=true";
...
<body onload="init()">
	<form method="post" name="form1" class="x-client-form"   action="/th/MultiRunningStatisticsServlet.html"  onSubmit="return check();">
		<div class="x-title"><span>&nbsp;&nbsp;报表管理-综合运行统计</span></div>
					...
					<tr>
						<td>
							<table width="100%"  class="x-data-table" >
								<tr>
									<th align="center" colspan='11'  class="x-data-table-th">综合运行统计表</th>
								</tr>
								<tr>
									<th align="center" class="x-data-table-th">序号</th>
									<th align="center" class="x-data-table-th">项目</th>
									<th align="center" class="x-data-table-th">开机率(%)</th>
									<th align="center" class="x-data-table-th">台日均频道点击(次)</th>
									<th align="center" class="x-data-table-th">台日最高频道点击(次)</th>
									<th align="center" class="x-data-table-th">台日最低频道点击(次)</th>
									<th align="center" class="x-data-table-th">台日均广告播放时长(秒)</th>
									<th align="center" class="x-data-table-th">台日均广告点击(次)</th>
								</tr>
								<%
									...
									if(viewList!=null){
										for(int i =0;i<viewList.size();i++){
											MultiRunningStatisticsBean multiRunningStatisticsBean = (MultiRunningStatisticsBean)viewList.get(i);
								...
								<tr class="<%=trClass%>"  onmouseover='OMOver(this);' onmouseout='OMOut(this);'>
									<td align="center" class="x-data-table-td"><%=multiRunningStatisticsBean.getRank()%></td>
									<td align="center" class="x-data-table-td"><%=multiRunningStatisticsBean.getMultiOrgName() %></td>
									<td align="center" class="x-data-table-td"><%=multiRunningStatisticsBean.getOpenRate()%></td>
									<td align="center" class="x-data-table-td"><%=multiRunningStatisticsBean.getAverageCount()%></td>
									<td align="center" class="x-data-table-td"><%=multiRunningStatisticsBean.getMaxClickCount()%><!-- 日均最高频道点击 --></td>
									<td align="center" class="x-data-table-td"><%=multiRunningStatisticsBean.getMinClickCount()%><!-- 日均最低频道点击 --></td>
									<td align="center" class="x-data-table-td"><%=multiRunningStatisticsBean.getAveragePlayTime()%></td>
									<td align="center" class="x-data-table-td"><%=multiRunningStatisticsBean.getAverageClickCount()%></td>
								</tr>
