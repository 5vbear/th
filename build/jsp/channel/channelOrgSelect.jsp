...
// 		 response.setContentType("text/html; charset=utf-8");
// 		 response.sendRedirect("/th/common/noaction.jsp");
// 		return;
// 	}else{
...
function redirect(orgID){
	...
	window.open("/th/jsp/channel/searchChannel.html?type=search&orgID="+orgID ,target='sub');
...
<div class="x-title"><span>&nbsp;&nbsp;频道管理</span></div>
...
<Iframe  src="/th/jsp/channel/searchChannel.html?type=search"  scrolling="no" height="600"  width="710"  frameborder="0" name="sub" id="sub"></iframe>
</form>
</body>
