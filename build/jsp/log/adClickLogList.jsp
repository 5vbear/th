...
/* 	//排序方式
	...
	//素材
	if(selectBean.getMedia_file_name()!=null)
	{
		mediaFileName = selectBean.getMedia_file_name();
	}
	//添加时间From
	...
	<script type="text/javascript">
	   var oCalendarChs=new PopupCalendar("oCalendarChs"); //初始化控件时,请给出实例名称:oCalendarChs
		...
		function adverClickLogSearch() {
			...
			window.document.form_data.pageId.value = 'advertising_Click';
		...
		function pageTurn (page) {
			...
			window.document.form_data.media_file_name.value = window.document.form_data.turnpage_media_file_name.value;
...
/* 		td {
	...
	<div class="x-title"><span>&nbsp;&nbsp;日志管理-广告点击日志</span></div>
	<body> 
		...
		<form class="x-client-form" name="form_data" action="<%=url %>" method="post">
			...
			<input type="hidden" name="turnpage_media_file_name" value="<%=mediaFileName %>">
			...
			<div id="foldId" style="width: 100%; display: block;height: 30px;line-height: 30px; background-color:#B2DFEE">
				...
				<div style="float: left">
					<span>&nbsp;&nbsp;素&nbsp;&nbsp;材</span> 
					<input type="text" name="media_file_name" value="<%=mediaFileName%>" style="width:120px"/>
				</div>
				<div style="float: left">
					<span>&nbsp;&nbsp;点击时间</span> 
				</div>
				...
				<input class="tableBtn" type="button" value="搜索" onclick="adverClickLogSearch();"/>
			</div>
		<table><tr style ="heigt:30px"></tr></table>	
		<div>
		    <div class="x-data">
		    ...
		    <div>
					<table id="mytable" cellspacing="0">
						<tr>
							...
							<th scope="col" style="width:25%" class="x-data-table-th">布局</th>
							<th scope="col" style="width:18%" class="x-data-table-th">素材</th>
							<th scope="col" style="width:20%" class="x-data-table-th">机器名</th>
							<th scope="col" style="width:6%" class="x-data-table-th">屏幕</th>
							<th scope="col" style="width:14%" class="x-data-table-th">点击时间</th>
						</tr>
						<% 
						if (resultBeans != null) {
						...
						<tr>				
							...
							<td class="x-data-table-td"><%=bean.getLayout_name()%></td>
							<td class="x-data-table-td"><%=bean.getMedia_file_name()%></td>
							<td class="x-data-table-td"><%=bean.getMachine_mark()%></td>
							<td class="x-data-table-td">主屏</td>
							<td class="x-data-table-td"><%=bean.getClick_time()%></td>
						</tr>
						<%		
							}
						}
