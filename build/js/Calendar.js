...
function CalendarInit()				///Create panel
{
	...
	htmlAll="<div id='"+this.sDIVID+"' style='z-index:101;display:none;position:absolute;width:300px;border:"+this.divBorderCss+";padding:2px;background-color:#FFFFFF'>";
	...
	for(i=this.startYear;i<=this.endYear;i++)
	{
		if(this.today.getFullYear() === i){
		  htmloYear+="<option value='"+i+"' selected='true'>"+i+"</option>";
		}else{
